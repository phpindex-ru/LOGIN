...
<?php $paginate->dataview($newquery); ?>
    ...
    <div class="col">
	Фильтр:<br>
	<form method="get" action="?controller=users&action=index&page_no=1">

	  <select name="page_status" class="form-control form-control-sm">
	  <option selected></option>
      <option>Илюстрации</option>
      <option>Програмирование</option>
	  <option>Верстка</option>
...
// $when->modify("+1 day");
//}
//print "<select name='page_status' class='form-control form-control-sm'>";
...
<a href = "resources/uploads/php.pdf">PHP Cookbook</a>
